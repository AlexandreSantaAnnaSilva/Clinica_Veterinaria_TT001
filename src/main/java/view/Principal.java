...
private ImageIcon resizeIcon(ImageIcon icon, int resizedWidth, int resizedHeight) {
    ...
    if (originalWidth > originalHeight) {
        ...
        newHeight = (int) (resizedWidth / aspectRatio);
    } else {
        // Retrato
    ...
    // Garante que a imagem não seja maior do que o espaço disponível
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Desenvolvido por Alexandre de C.A.S Silva - 248488");
        ...
        jLabel16.setText("Desenvolvido por Alexandre de C.A.S Silva - 248488");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jTable2.getModel() instanceof AnimalTableModel) {
            ...
            if(selectedRow >= 0){
                Animal animalSelecionado = (Animal) ((AnimalTableModel)jTable2.getModel()).getItem(selectedRow);
                Controller.excluirConsultasPorAnimalId(animalSelecionado.getId());

            // Agora, exclua o animal
